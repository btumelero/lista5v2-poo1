...
public class Tigre extends Animal
  ...
  public void anda(Posicao posDestino){
    if (checaPosicao(posDestino)==true) {
      System.out.println("Tigre andando de X: " + x + ", Y: " + y + " "
        ...
        while(y!=posDestino.y) {
          if (posDestino.y>y) {
            if (InterfaceGrafica.mapa[x][y+1]==TipoTerraAgua.TERRA) {
              ...
              System.out.println("O tigre chegou até a margem e, por isso, não pode andar além desta posição.");
              break;
            }
          } else {
            if (InterfaceGrafica.mapa[x][y-1]==TipoTerraAgua.TERRA) {
      ...
      System.out.println("O tigre não pode ser movido");
    }
  }
